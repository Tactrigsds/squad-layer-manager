...
export const setupLayerQueueAndServerState = C.spanOp('layer-queue:setup', { tracer }, async () => {
...
const updateQueue = C.spanOp(
	'layer-queue:update',
	{ tracer },
	async ({ input, ctx }: { input: M.UserModifiableServerState; ctx: C.TrpcRequest }) => {
