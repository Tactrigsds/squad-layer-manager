...
// rolled back with the transaction anyway). See dev_docs/architecture.md.
//
...
function reportAsyncTx(callSite: Error): void {
	const msg =
		...
		'result, or defer it with ctx.tx.unlockTasks if it is a side effect of the write. See dev_docs/architecture.md.'
	switch (ENV.NODE_ENV) {
