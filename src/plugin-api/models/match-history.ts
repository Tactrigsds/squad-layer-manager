/**
 * Match shapes, and the team1/team2 <-> A/B normalization every one of them needs. Row conversion and
 * entry creation belong to the host, as does MH.Ctx: a plugin receives its ctx already built.
 */
export {
	getDenormedTeamId,
