 ...
 * slm/plugin/* (config, servers, rpc.server, ...) and the reachable core surface under
 * slm/lib|models|systems.
 */
export { API_VERSION, definePlugin, defineTables } from '@/models/plugins.models'
export type { Config, ConfigInput, Manifest, PluginId, PluginMigration, TableFactory } from '@/models/plugins.models'
